...
public class ShoppingCartController {
    ...
    @Autowired
    private ShoppingCartUnauthorizedService shoppingCartUnauthorizedService;
    ...
    @RequestMapping("/cartUnauthorized")
    public String shoppingCartUnauthorized(Model model) {
        ShoppingCartUnauthorized shoppingCartUnauthorized = new ShoppingCartUnauthorized();
...
*/
        ...
        /*shoppingCartUnauthorizedService.updateShoppingCartUnauthorized(shoppingCartUnauthorized);*/

//        model.addAttribute("cartItemUnauthorizedList", cartItemUnauthorizedList);
        model.addAttribute("shoppingCartUnauthorized", shoppingCartUnauthorized);
    ...
    /*@RequestMapping("/addItemIndexUnauthorized")
    public String addItemIndexUnauthorized(
            Product product, Model model, Principal principal
    ) {
       ...
       *//* CartItem cartItem = cartItemUnauthorizedService.addProductToCartItemUnauthorized(product, qty, s);
        model.addAttribute("addProductSuccess", true);
        if (principal != null) {
