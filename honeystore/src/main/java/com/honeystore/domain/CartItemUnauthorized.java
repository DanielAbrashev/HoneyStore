...
public class CartItemUnauthorized {
    ...
    @JsonIgnore
    private List<ProductToCartItemUnauthorized> productToCartItemListUnauthorized;
    ...
    public List<ProductToCartItemUnauthorized> getProductToCartItemListUnauthorized() {
        return productToCartItemListUnauthorized;
    }

    public void setProductToCartItemListUnauthorized(List<ProductToCartItemUnauthorized> productToCartItemListUnauthorized) {
        this.productToCartItemListUnauthorized = productToCartItemListUnauthorized;
    }
